...
public class KycController {
    ...
    public ResponseEntity<?> validatePanNumber(@RequestBody KycPayload request) {
        ...
        panState.setAddress("Anur, Kagal, Kolhapur, Maharashtra, Anur, 416235, India");
        panState.setGender("MALE");
        panState.setAadhaarLinked("true");
        panState.setBirthDate("1995-04-01");
        panState.setFullName("KIRANKUMAR BALKRUSHNA BHOLE");
        panState.setMaskedAadhaar("XXXXXXXX5026");
        panState.setPanNumber("CSIPB0017L");
    ...
    public ResponseEntity<?> validateAdhar(@RequestBody KycPayload request) {
        ...
        adharState.setFullName("Kirankumar Balkrushna Bhole");
